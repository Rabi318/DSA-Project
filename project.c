...
//Online Voting System using Linked List
...
int *z;
 z = &UNIVERSAL;
     ...
     while(temp!=NULL)
     {
         if((strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"Rabi Kumar")==0 &&strcmp(temp->birth_date,"31-03-1999")==0) ||
         (strcmp(temp->aadhar,"10002")==0&& strcmp(temp->name,"Biswajit Muduli")==0 &&strcmp(temp->birth_date,"01-01-1999")==0)||
         (strcmp(temp->aadhar,"10003")==0&& strcmp(temp->name,"Abinash Jena")==0 &&strcmp(temp->birth_date,"12-10-1999")==0)||
         (strcmp(temp->aadhar,"10004")==0&& strcmp(temp->name,"Suraj Kumar Jena")==0 &&strcmp(temp->birth_date,"08-12-1999")==0)||
         (strcmp(temp->aadhar,"10005")==0&& strcmp(temp->name,"Bishnu Charan Sahoo")==0 &&strcmp(temp->birth_date,"28-08-1999")==0)||
         (strcmp(temp->aadhar,"10006")==0&& strcmp(temp->name,"Subhasis Das")==0 &&strcmp(temp->birth_date,"20-10-2000")==0)||
